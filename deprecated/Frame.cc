...
void Frame::AssignFeaturesToGrid() {
    auto nReserve = static_cast<unsigned long>(0.5f*N/(FRAME_GRID_COLS*FRAME_GRID_ROWS));
...
void Frame::ComputeStereoMatches() {
    ...
    for(int iR = 0; iR < Nr; iR++) {
        ...
        const int maxr = static_cast<int>(ceil(kpY + r));
        const int minr = static_cast<int>(floor(kpY - r));
